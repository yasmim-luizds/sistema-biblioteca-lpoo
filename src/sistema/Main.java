...
public class Main {
    ...
    private static void menuAdmin(SistemaBiblioteca sistema, Admin admin) {
        while (true) {
            ...
            switch (opcao) {
                case 1 -> cadastrarLivro(sistema, admin);
                case 2 -> cadastrarAluno(sistema);
                case 3 -> cadastrarProfessor(sistema);
                case 4 -> listarLivros(sistema);
                case 5 -> listarUsuarios(sistema);
                case 6 -> listarEmprestimos(sistema);
                case 7 -> aprovarEmprestimoPendente(sistema, admin);
                case 8 -> registrarDevolucaoAdmin(sistema, admin);
                case 9 -> removerLivro(sistema, admin);
                case 10 -> {
    ...
    private static void menuUsuario(SistemaBiblioteca sistema, Usuario usuario) {
        while (true) {
            ...
            switch (opcao) {
                case 1 -> listarLivros(sistema);
                case 2 -> solicitarEmprestimoUsuario(sistema, usuario);
                case 3 -> listarMeusEmprestimos(sistema, usuario);
                case 4 -> verMultas(usuario, sistema);
                case 5 -> {
